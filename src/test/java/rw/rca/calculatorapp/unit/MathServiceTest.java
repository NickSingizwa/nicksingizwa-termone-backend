...
public class MathServiceTest {
    ...
    @Test
    public void return_number_on_addition_success(){
    ...
    @Test
    public void return_number_on_subtraction_success(){
        double actualResult = mathService.doMath(20.0,2.0,"-");
    ...
    @Test
    public void return_number_on_multiplication_success(){
        double actualResult = mathService.doMath(20.0,2.0,"*");
    ...
    @Test
    public void return_number_on_division_success(){
        double actualResult = mathService.doMath(20.0,2.0,"/");
    ...
    @Test
    public void return_number_on_power_success(){
        double actualResult = mathService.doMath(20.0,2.0,"**");
    ...
    @Test
    public void _return_number_on_log_success(){
    ...
    @Test
    public void return_number_on_ln_success(){
